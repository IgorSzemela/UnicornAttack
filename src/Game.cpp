...
void Game::DrawBorder(SDL_Surface* screen, Uint32 outlineColor, int l, int  k) {	
	DrawLine(screen, 0, 0, k, 0, 1, outlineColor);//vertical
	DrawLine(screen, l - 1, 0, k, 0, 1, outlineColor);//vertical
	DrawLine(screen, 0, 0, l, 1, 0, outlineColor);//horizontal
	DrawLine(screen, 0, k - 1, l, 1, 0, outlineColor);//horizontal
};
